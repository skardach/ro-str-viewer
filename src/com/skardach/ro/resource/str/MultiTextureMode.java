...
public enum MultiTextureMode {
	...
	/**
	 * read enum value from int.
	 * @param iMode int value to interpret.
	 * @return Return enum value according to int value.
	 */
	public static MultiTextureMode fromInt(int iMode)
	{
		switch(iMode) {
